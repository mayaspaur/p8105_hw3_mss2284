...
The `accelerometer_data`day dataset has 1443 variables and 35 observations. Key variables include week and day.
...
accelerometer_plot =
accelerometer_data %>%
  ggplot(aes(x = minutes, y = activity_counts, color = day)) + geom_line()
